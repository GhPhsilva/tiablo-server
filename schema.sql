...
CREATE TABLE IF NOT EXISTS `players` (
    ...
    `skill_reflect_damage` int(11) NOT NULL DEFAULT '0',
    `skill_reflect_damage_tries` bigint(20) NOT NULL DEFAULT '0',
    `skill_reflect_chance` int(11) NOT NULL DEFAULT '0',
    `skill_reflect_chance_tries` bigint(20) NOT NULL DEFAULT '0',
